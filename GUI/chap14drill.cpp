...
class B1
{
	public:
			...
			//virtual void pvf() = 0; {cout << "B1::pvf" << endl;} // 5. feladat: error, alosztályban lehetne definiálni
};
...
class D1 : public B1
{
	public:
		...
		void f() {cout << "D1::f" << endl;}  // 4. feladat: ebben a formában is felülíródik a B1, mint olyan és D1:f-et ad vissza 
...
{
	public: 
		void pvf() override {cout << "D2::pvf" << endl;} //6. fel
};
